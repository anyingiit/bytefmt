...
Report it privately instead. Open the **Security** tab of this repository and choose **Report a vulnerability**, or go directly to https://github.com/anyingiit/bytefmt/security/advisories/new.

If the vulnerability also affects the upstream [cloudfoundry/bytefmt](https://github.com/cloudfoundry/bytefmt), please report it to the Cloud Foundry Foundation as well, following https://www.cloudfoundry.org/security/.
